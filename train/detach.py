...
pathname = ["measure7"]
samplec = 0
# end = "D:/PythonCode/noise/nppd/data/sampleset_v1/test8/"
end = "E:/BaiduNetdiskDownload/"
for dirs in pathname:
    ...
    for i in range(160):
        ...
        ds = zarr.group(store = zarr.ZipStore(end+zippath, mode='r'))
        # color = decompress_RGBE(ds.color, ds.exposure)
        ...
        # ref = np.transpose(ds.reference, (1, 2, 0))

        # write_two_exr("./video/bistro3/motion/motion-"+ str(i) + ".exr",tmotion)
        # write_one_exr("./video/bistro3/depth/depth-" + str(i) + ".exr", t_depth)
        # write_RGB_exr("./video/bistro3/ref/ref-" + str(i) + ".exr", ref)
        # write_RGB_exr("./video/bistro3/noise/noise-" + str(i) + ".exr", tcolor)
        # write_RGB_exr("./video/bistro3/albedo/albedo-" + str(i) + ".exr", talbedo)
        # write_RGB_exr("./video/bistro3/normal/normal-" + str(i) + ".exr", tnormal)
        write_RGB_exr("./video/measure/position/position-" + str(i) + ".exr", tposition)
